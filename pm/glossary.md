...
| **Scheduled day (K-W2D1)** | The **calendar**: one actual day of work — Kristen, week 2, day 1. Built **city-first per Kristen (Aug 7)**: a contiguous drive chain of whoever is DUE that week (T1 21d · T2 30d · T3 45d on actual MMC check-ins), each stop within ~5 miles of the last, same-building practices together (🏢), prospects riding along, 📝 = has MMC field notes. Days of 1–3 stops are far-pocket **short runs**. One Weekly Plan row = one drive; *Stops by Day* lists the same days stop-by-stop. |
