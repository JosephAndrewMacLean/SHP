...
| **Home route day (K-R01…)** | **Superseded Sep 22 by cells (above); kept for reading W1–W8 history.** The **geography reference**: city-block clusters of ≤10 accounts (97 across the team, built Aug 7 from MMC cities + exact pins; small neighbouring towns merge only within ~7 miles). It's the value in MMC's `Route Day` field and the *Territory* tab — you drive *scheduled days*, not home days. |
