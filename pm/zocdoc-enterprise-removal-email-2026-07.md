# Email draft — Zocdoc Enterprise: visit-reason removal request

**Status: DRAFT — pending Paul/leadership sign-off. Fill every [bracket] before sending.**
Backing analysis: `pm/zocdoc-visit-reason-removal-2026-07.md`

---

**To:** [Zocdoc Enterprise account manager / enterprise-support@zocdoc.com]
**Cc:** Paul [last name], [practice ops lead]
**From:** Joseph MacLean — jmaclean@synergyhealth.org
**Subject:** Synergy Health Partners — request to remove 7 visit reasons from Marketplace discovery
...
- **Marketplace/discovery only.** Please keep these reasons available in the direct booking
  flow from our own website (synergyhealth.org). If any reason can't be scoped that way, let us
  know and we'll decide it individually — Ultrasound and Pain Medication Prescription can be
  removed everywhere.
- **Related demand should keep routing to us** through our structured reasons — e.g.,
  Orthopedic Consultation (Spine & Back) and Spinal Cord Surgery Consultation remain active
  for back/spine searches, which convert materially better for us.

Could you confirm in writing:

1. The effective date of the change;
2. That no new-patient booking fees accrue for these visit reasons after that date;
3. That already-booked future appointments under these reasons are unaffected;
4. And send an updated visit-reason configuration/report once live so we can verify against
   our next monthly export.

Separately — not blocking the removal — we'd like to schedule a call to review per-booking
pricing on several orthopedic consultation reasons where our fully-loaded cost per kept patient
is running well above our account average, and we're glad to walk through the reconciliation
data (aggregate figures only). [Optional: propose 2–3 time windows.]

We'd like this live before September; please confirm receipt and timeline by [date + ~5 business
days].

Thank you,

Joseph MacLean
[Title], Synergy Health Partners
jmaclean@synergyhealth.org · [phone]
[Practice/account ID: ___]
...
- [ ] Delete this checklist + the "Status: DRAFT" header
