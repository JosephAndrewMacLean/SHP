...
| No Troy coverage; Southfield near-zero | 🟠 **first Troy move in motion 2026-08-05** | Blue Ox thread "Dr. Sorensen — Troy New-Patient Demand Opportunity" (Gautam ask): Troy podiatry ZIP set + Southfield (Leff) tightening delivered — see `pm/podiatry-zip-targeting-troy-southfield-2026-08-05.md`. Scope = podiatry pod only, start-small per Shaun/Joe; Troy ortho/spine coverage still ❌. GA4 note: a second podiatry campaign ("BOD - Podiatry - East Side") has been live since Apr 2026 and bleeds into Troy — ZIP dedupe requested. |
