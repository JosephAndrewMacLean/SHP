...
| Reduce "Website – New Patient Intent" value $125→$5; recalc ROAS targets | ✅ **done 2026-07-31 — at $75, not $5** | Joe reduced $125→**$75**, derived from GA4 click→book→keep rates (not Cardinal's flat $5 — the online-booking signal is still broken, so NP-intent remains the only scheduler proxy; agreed with Evan/Gautam 7/24). Retirement plan: once ZocDoc booking signal posts to Ads + 30 qualified conv/30d per campaign, remove entirely (Liine call 7/29). **Watch-item (Blue Ox 8/3):** under tROAS this may shift mix toward $150/$5 phone calls (values Liine guessed, not derived) — monitor ZocDoc bookings vs. call mix daily. |
| Switch existing-patient conversions to Secondary | ✅ **done ~2026-07-28 (Joe)** | Existing-patient actions moved to secondary in Ads. Early effect: new patients trending ~+10/wk vs prior two weeks (7/29 Liine call) — consistent with the account having been optimizing toward existing patients; also candidate explanation for the 147→112→105 ortho slide. |
...
| Ad-group buildout (Spine 4→10 groups etc.), quality score 4→up | 🟠 **spec delivered; revised 8/3** | Full build spec + keyword sheet delivered to Blue Ox (`playbooks/spine-keyword-expansion-2026-07.md`, 366 keyword rows, exact+phrase only). Per 8/3 call: 9 ad groups per geo — low-funnel in geo NBS campaigns, condition groups in Spine Conditions campaigns; **no broad match** (contra Cardinal's broad-match guidance — account history: broad pulls chiro/massage/PT); Port Huron & Southfield spine winding down (Dr. Munk departing). Blue Ox building, sciatica first. |
