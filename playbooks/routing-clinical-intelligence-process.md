...
| Surgeon-matching statement ("scoliosis or failed fusion → Dr. X") | Mitch-approved matching matrix; consistent with the call-center rubric | Mitch (+ Katie for routing ops) | Do not imply routing the practice hasn't approved |
